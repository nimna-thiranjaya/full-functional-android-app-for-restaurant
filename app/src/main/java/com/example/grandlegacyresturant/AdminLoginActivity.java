    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            forbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent =new Intent(AdminLoginActivity.this,FogetPasswordActivity.class);
                ...
                mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AdminLoginActivity.this,"Login Successful" +task.getException(), Toast.LENGTH_SHORT).show();
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(AdminLoginActivity.this, "Login Fail" + task.getException(), Toast.LENGTH_SHORT).show();
                        }
